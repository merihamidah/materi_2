		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row">
				<div class="col-lg-6 about-left-w3pvt">
					<div class="main-img">
						<img src="{{ url('public') }}/_src/images/ab.jpg" alt="" class="img-fluid pos-aboimg2">
					</div>
				</div>
				<div class="col-lg-6 about-right pt-5">
					<h4 class="sub-tittle-w3layouts let">Welcome to our site</h4>
					<h3 class="tittle-w3layouts text-uppercase pr-lg-5 mt-2">Tujuan Beauty Up </h3>
					<p class="mt-4 mb-5">Menjadi Online shop  terkemuka di bidang  kecantikan. 
                        Kami  memberikan Produk produk terbaik , terbaru dan terhits dan 
                        juga yang paling sering digunakan. Menjadikan Online shop tempat kaum hawa khususnya 
                        dalam mencari produk produk yang aman dan tepercaya </p>
