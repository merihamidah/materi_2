...
<html lang="en">
  ...
  <div class="containerlogin ">
     <h1 class="display-4 ">Welcome To <br > Beauty Up</h1><br >
     <h4 ">Get hits, new and cheap products with
      a variety of interesting recommendations.</h4>
     <form style="padding-top: 30px;padding-bottom: 80px;margin-top: 30px;" class="  bg-light">
