...
<body id="page-top">
  <div id="wrapper">
    @include('project3.section.sidebar')
    <!-- Content Wrapper -->
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Topbar -->
        @include('project3.section.header')
       ...
       @include('project3.section.footer')
      <!-- End of Footer -->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="{{ url('loginp3')}}">Logout</a>
        </div>
      </div>
    </div>
  </div>
